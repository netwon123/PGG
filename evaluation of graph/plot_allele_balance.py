...
INDEL_SIZE_LIMIT = 40
colors_original={ "bowtie2":"#aaaa00", "bwa_mem":"#82B0D2", "giraffe":"#FA7F6F", "giraffe_fast":"#99ddff", "giraffe_primary":"#77aadd", "graphaligner":"#bbcc33", "hisat2":"#ee8866", "vg_map":"#8ECFC9", "minimap2":"#dddddd"}
...
def main():
    ...
    panel.scatter(indel_lengths_bwa, indel_fractions_bwa, label="bwa mem", color=colors_original["bwa_mem"],alpha=0.75)
    ...
    panel.scatter(indel_lengths_map, indel_fractions_map, label="vg ref", color=colors_original["vg_map"],alpha=0.75)
    ...
    panel.scatter(indel_lengths_giraffe, indel_fractions_giraffe, label="vg giraffe", color=colors_original["giraffe"],alpha=0.75)
